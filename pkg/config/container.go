...
type Container struct {
	...
	Network string `hcl:"network" json"network"` // name of a network to attach the container to
	...
	IPAddress   string   `hcl:"ip_address,optional" json:"ip_address,omitempty"` // ip address for the container, if empty ip is autogenerated
