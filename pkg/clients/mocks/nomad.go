...
// HealthCheckAPI provides a mock function with given fields: _a0
func (_m *Nomad) HealthCheckAPI(_a0 time.Duration) error {
	ret := _m.Called(_a0)
...
func NewNomad(t mockConstructorTestingTNewNomad) *Nomad {
	mock := &Nomad{}
	mock.Mock.Test(t)
